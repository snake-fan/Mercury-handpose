...
public:
	...
	struct xrt_hand_masks_sink *hand_masks_sink = nullptr;

	float multiply_px_coord_for_undistort = 1.0f;
	...
	lm::KinematicHandLM *kinematic_hands[2] = {nullptr, nullptr};
	...
	void (*keypoint_estimation_run_func)(void *) = nullptr;
